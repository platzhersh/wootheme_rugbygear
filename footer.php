...
if ( is_user_logged_in() ) {
    global $current_user;
      get_currentuserinfo();
      echo '<script>var user_login="' . $current_user->user_email . '";';
	  echo "jQuery('#top-nav li a[title=\"account\"]').text('". $current_user->user_email ."');</script>";	  
} else {
    echo '<script>var user_login="";</script>';
};
?>
</body>
</html>