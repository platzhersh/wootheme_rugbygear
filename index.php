...
?>
    ...
    <div id="content" class="col-full <?php if ( $woo_options[ 'woo_homepage_banner' ] == "true" ) echo 'with-banner'; ?> <?php if ( $woo_options[ 'woo_homepage_sidebar' ] == "false" ) echo 'no-sidebar'; ?>">
    	...
    	<!--- frontpage precontent widget - added by platzh1rsch -->

    	<div id="frontpage-precontent">

			<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('frontpage-precontent')) : else : ?>
    	...
    	<!--- end frontpage precontent widget -->
